...
import { Product, ProductModel } from './products/models/product';
import { Manufacturer, ManufacturerModel } from './manufacturers/models/manufacturer';
import { Merchant, MerchantModel } from './merchants/models/merchant';
import { Catalog, CatalogModel } from './catalogs/models/catalog';
import { Category, CategoryModel } from './categories/models/categorie';
import { Item, ItemModel } from './items/models/item';
